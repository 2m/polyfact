        ...
        factorizeButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(frame, "n is invalid.", "Wrong value of n", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(frame, "q is invalid.", "Wrong value of q", JOptionPane.ERROR_MESSAGE);
                    return;
                }

                if (n < 1) {
                    JOptionPane.showMessageDialog(frame, "n must be greater than zero.", "Wrong value of n", JOptionPane.ERROR_MESSAGE);
                    return;
                }

                if (q < 2) {
                    JOptionPane.showMessageDialog(frame, "q must be greater than one.", "Wrong value of q", JOptionPane.ERROR_MESSAGE);
                    return;
                }

                // check if q is prime with probability exceeding 1 - (1/2)^4
                if (!BigInteger.valueOf(q).isProbablePrime(4)) {
                    JOptionPane.showMessageDialog(frame, "q must be prime.", "Wrong value of q", JOptionPane.ERROR_MESSAGE);
                    return;
                }
