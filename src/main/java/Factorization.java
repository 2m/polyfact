...
public class Factorization {
  ...
  /** Prepares for the factorization of polynomial x^n - 1 above the field Fq. */
  ...
  /** Construct basis for G. Which is a mapping between cyclotomic cosets and polynomials. */
  ...
  /** Format cyclotomic cosets as a HTML string. Used for GUI. */
  ...
  /** Format basis for G as a HTML string. Used for GUI. */
  ...
  /** Format factors as a HTML string. Used for GUI. */
