...
/**
 * Polynomial class is generic. It can use any class
 * derived from FieldElement class as coefficients.
 */
public class Polynomial<T extends FieldElement> {

    /**
     * Holds all coefficients of the Polynomial.
     * ArrayList is zero indexed, so
     * coefficient at index 0 is coefficent at x to the power of 0,
    ...
    /**
     * Special constructor used for easy polynomial creation.
     * Works only for coefficients which can be specified as one character.
     * Usage:
     *      p = new Polynomial(FiniteFieldElement.class, "001101");
     *      will create polynomial: x^2 + x^3 + x^5.
     *
     * This constructor is used extensively in the Test class.
     */
    ...
    /**
     * Sets coefficient at specifiend index.
     * If polynomial is shorter than index, extends with zero coefficients.
     *
     ...
     *              or null if polynomial is shorter then index
     */
    ...
    /**
     * Subtract integer from polynomial, which means,
     * subtract integer from the zero coefficient.
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * Remove trailing zeros from the coefficient ArrayList.
     * Since the degree of polynomial is the size of coefficient ArrayList,
     * trailing zeros at the and of this list, would mean wrong degree.
     */
    ...
    /**
     * Equality of two polynomials is defined as
     * 1. Equality of the degrees.
     * 2. And equality of the coefficients.
     */
    @SuppressWarnings("unchecked")
